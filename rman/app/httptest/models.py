...
class CaseRequests(db.Model):
    ...
    def __init__(self, glob_var, glob_regx,pre_command,url,method,hearders,body,post_command,verify,case_id,create_time,update_time):
